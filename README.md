...
It catches removed or renamed symbols, changed function signatures, struct layout drift, vtable reordering, enum value reassignment, and many more — **250 ABI/API change types** in total — that cause crashes, silent data corruption, or linker failures after a library upgrade.
