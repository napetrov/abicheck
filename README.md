...
Add ABI checking to your CI pipeline without writing shell scripts:
...
The action installs Python, castxml, and abicheck automatically. It supports all
CLI options as inputs, writes a Job Summary, and can upload SARIF results to
GitHub Code Scanning.

See the [full GitHub Action documentation](https://napetrov.github.io/abicheck/github-action/)
for examples including baseline workflows, SARIF integration, cross-compilation,
and multi-library matrix builds.
