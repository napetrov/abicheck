...
|---------------------------------|----------|-------|---------|
| Change kind/type classification | `type_size_changed` (machine-parseable enum of 239 change kinds) | Narrative text only | Narrative text |
...
| **239-kind change taxonomy** | MEDIUM — machine-parseable enum vs free-text descriptions |
