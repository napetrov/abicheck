...
|---------------------------------|----------|-------|---------|
| Change kind/type classification | `type_size_changed` (machine-parseable enum of 238 change kinds) | Narrative text only | Narrative text |
...
| **238-kind change taxonomy** | MEDIUM — machine-parseable enum vs free-text descriptions |
