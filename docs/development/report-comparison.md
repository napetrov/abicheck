...
|---------------------------------|----------|-------|---------|
| Change kind/type classification | `type_size_changed` (machine-parseable enum of 235 change kinds) | Narrative text only | Narrative text |
...
| **235-kind change taxonomy** | MEDIUM — machine-parseable enum vs free-text descriptions |
