...
> Generated: 2026-03-09; content reviewed 2026-06-07. The scenario matrix is a historical ABICC/libabigail parity snapshot; the current ChangeKind total is **245** — see the [Change Kind Reference](../reference/change-kinds.md) for the authoritative list.
...
- **Coverage: exceeds ABICC** — the original ABICC-equivalent matrix remains covered, and the full current catalog has grown to 245 ChangeKinds.
