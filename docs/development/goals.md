...
| Goal | Status |
|------|--------|
| G1: ABICC drop-in | Done — 235 ChangeKinds, compat CLI, suppression files, XML reports |
...
| G3: libabigail tests | Done — ~54 parity test functions + 127 example cases |
| G4: Agent-friendly | Done — JSON, SARIF, exit codes, snapshots, MCP server, GitHub Action |
| G5: Break encyclopedia | Done — 127 example cases + consolidated ABI/API handling guide + coverage matrix |
