...
Detects 189 ABI/API change types across ELF, PE/COFF, and Mach-O binaries,
...
- `ChangeKind` (`checker_policy.py`) — enum of 189 change types; categorized into `BREAKING_KINDS`, `API_BREAK_KINDS`, `COMPATIBLE_KINDS`, `RISK_KINDS`
